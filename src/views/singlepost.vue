<template>
  <div>
      ...
      <aside>
          <h3>Popular Posts</h3>
          <div class="row">
            <div class="column" v-for="post in posts.slice(postCount)" :key="post._id">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <router-link :to="{name: 'newpost', params:{id: post._id}}">
          ...
          <div class="wordpic">
            <div class="circleimg">
                <img class="authorimage" src="../assets/author.jpg">
            </div>
            <div class="wordings">
